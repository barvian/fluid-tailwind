...
<div class="aspect-[952/554] @container mt-[2em]">
  <video src={inspector} poster={(await getImage({ src: poster })).src} autoplay controls muted class="rounded-[1cqw] my-0 overflow-clip" />
</div>
