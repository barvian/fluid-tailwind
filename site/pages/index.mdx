...
headline: Smoother responsive styles in less HTML.
lead: 'A <a href="https://www.smashingmagazine.com/2022/01/modern-fluid-typography-css-clamp/">fluid <code>clamp()</code></a> plugin for Tailwind that uses your existing scales.'
---
...
* Shorter classes than non-fluid utilities (i.e. `pt-4 md:p-8 lg:pt-10`), and similar output CSS size (**+0.6kB** to fluidize [tailwindcss.com](https://tailwindcss.com); compressed)
