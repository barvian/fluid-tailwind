...
<Steps.Root>
  <Steps.Item>
    **Install the package**
    ...
    Install `@fluid.tw/plugin` via npm.
    <Fragment slot="code">
    ```sh
    npm install -D @fluid.tw/plugin
    ```
    </Fragment>
  </Steps.Item>
  <Steps.Item>
    **Add the [extractor](https://tailwindcss.com/docs/content-configuration#customizing-extraction-logic)**
    ...
    <Fragment slot="code">
      ...
      import { fluidExtractor } from '@fluid.tw/plugin'
  ...
  <Steps.Item>
    **Add the fluid core plugins**
    ...
    <Fragment slot="code">
      ...
      import { fluidExtractor, fluidCorePlugins } from '@fluid.tw/plugin'
  ...
  <Steps.Item>
    **(Optional) Use `rem` screens and font sizes**
    ...
    <Fragment slot="code">
      ...
      import { fluidExtractor, fluidCorePlugins, defaultThemeScreensInRems, defaultThemeFontSizeInRems } from '@fluid.tw/plugin'
...
import { ..., type FluidConfig } from '@fluid.tw/plugin'
...
import { ..., fluidize } from '@fluid.tw/plugin'
