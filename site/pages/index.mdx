...
* Ensures all fluid type meets [accessibility requirements](https://www.smashingmagazine.com/2023/11/addressing-accessibility-concerns-fluid-type/)
...
<Steps.Root>
  ...
  <Steps.Item>
    ...
    <Fragment slot="code">
      ```ts title="tailwind.config.ts" ins={1, 6} ins=/\: (\{)/ ins="files: " ins=/\](,)/ ins=/(\}),/
