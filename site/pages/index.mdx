...
<Steps.Root>
  ...
  <Steps.Item>
    ...
    <Fragment slot="code">
      ```js title="tailwind.config.js" ins=", { extract }" ins={6} mark=/\: (\{)/ mark="files: " mark=/\](,)/ mark=/(\}),/
  ...
  <Steps.Item>
    <>
      ...
      You can skip this if you override Tailwind's default screens or use [`tw-reset`](https://github.com/barvian/tw-reset).
