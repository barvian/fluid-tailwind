...
title: Smoother responsive styles in less code.
description: Smoother responsive styles in less code.
lead: Modernize your Tailwind sites using your existing scales.
---
...
* Ensures all fluid text meets [accessibility requirements](https://www.w3.org/WAI/WCAG21/Understanding/resize-text.html)
...
<Steps.Root>
  <Steps.Item>
    **Install the package**
    ...
    Install `@barvian/tailwindcss-fluid` via npm.
    <Fragment slot="code">
    ```sh
    npm install -D @barvian/tailwindcss-fluid
    ```
    </Fragment>
  </Steps.Item>
  <Steps.Item>
    **Add the [extractor](https://tailwindcss.com/docs/content-configuration#customizing-extraction-logic)**
    ...
    <Fragment slot="code">
      ...
      import { fluidExtractor } from '@barvian/tailwindcss-fluid'
  ...
  <Steps.Item>
    **Add the fluid core plugins**
    ...
    <Fragment slot="code">
      ...
      import { fluidExtractor, fluidCorePlugins } from '@barvian/tailwindcss-fluid'
  ...
  <Steps.Item>
    **(Optional) Use `rem` screens and font sizes**
    ...
    <Fragment slot="code">
      ...
      import { fluidExtractor, fluidCorePlugins, defaultThemeScreensInRems, defaultThemeFontSizeInRems } from '@barvian/tailwindcss-fluid'
...
import { ..., type FluidConfig } from '@barvian/tailwindcss-fluid'
...
import { ..., fluidize } from '@barvian/tailwindcss-fluid'
