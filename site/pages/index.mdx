...
<Steps.Root>
  ...
  <Steps.Item>
    <>
      ### Convert Tailwind's default screens and font sizes to `rem`
...
You can configure the plugin to warn about these 
failures instead of erroring:
