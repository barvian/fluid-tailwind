...
<main class="~p-6/10 p-6 md:p-8 lg:p-10">
  <div class="max-w-4xl mx-auto">
    ...
    <div class="flex gap-4 items-center">
      ...
      <button type="button" class="bg-slate-900 flex gap-1 items-center dark:bg-white text-white dark:text-slate-900 text-sm leading-6 font-medium p-2 @lg:px-3 rounded-full @lg:rounded-lg">
