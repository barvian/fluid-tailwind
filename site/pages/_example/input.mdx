```html title="index.html" del=/( p-6.*?)"/ ins="~p-6/10" del=" text-lg md:text-xl lg:text-2xl" ins=/~text-lg\/2xl/ ins="~mb-4/6" del=" mb-4 md:mb-5 lg:mb-6" ins="~mt-1/2.5" del=" mt-1 lg:mt-2.5"
<main class="~p-6/10 p-6 md:p-8 lg:p-10">
  <div class="max-w-4xl mx-auto">
    <div class="~mb-4/6 mb-4 md:mb-5 lg:mb-6 grid grid-cols-2 gap-4">
    ...
    <div class="flex gap-4 items-center">
      <div class="flex-1">
        ...
        <p class="~text-lg/2xl text-lg md:text-xl lg:text-2xl block font-semibold text-slate-900 dark:text-white">Beach House in Collingwood</p>
      </div>
    ...
    <p class="mt-4 text-sm leading-6 dark:text-slate-400">
      Nestled just steps away from the pristine sands of Coronado Beach, our luxurious beach house offers an unparalleled coastal living experience. With its modern design and ocean-inspired decor, Seaside Serenity provides the perfect blend of comfort and elegance for families, couples, and friends seeking a relaxing retreat.    </p>
  </div>
</main>
