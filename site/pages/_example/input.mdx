```html title="index.html" del=" p-6 md:p-8 lg:p-10" ins="p-fl-6/10" del=" text-lg md:text-xl lg:text-2xl" ins=/text-fl-lg\/2xl/ ins="mt-fl-4/6" del=" mt-4 md:mt-5 lg:mt-6" ins="~mt-1/2.5" del=" mt-1 lg:mt-2.5"
<main class="p-fl-6/10 p-6 md:p-8 lg:p-10">
  ...
  <div class="mt-fl-4/6 mt-4 md:mt-5 lg:mt-6 flex gap-4 items-center">
    <div class="flex-1">
      <span class="text-sm font-medium text-slate-500 dark:text-slate-400">Entire house</span>
      <p class="text-fl-lg/2xl text-lg md:text-xl lg:text-2xl block font-semibold text-slate-900 dark:text-white">Beach House in Collingwood</p>
    </div>
